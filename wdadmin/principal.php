...
if (isset($_SESSION['wd_logado'])):
    ...
    <html lang="pt-br">
        <head>
            ...
            <!--Custom JavaScript -->
            <script src="<?php echo URL ?>wdadmin/js/custom.min.js"></script>
        </head>
                    ...
                    <div class="scroll-sidebar">
                        ...
                        <nav class="sidebar-nav">
                            <ul id="sidebarnav">
                                ...
                                <li>
                                    <a class="has-arrow waves-effect waves-dark" aria-expanded="false"><i class="mdi mdi-account-box"></i><span class="hide-menu">RH</span></a>
                                    <ul aria-expanded="false" class="collapse">
                                        <li><a href="<?php echo URL ?>wdadmin/rh-vagas">Vagas</a></li>
                                        <li><a href="<?php echo URL ?>wdadmin/rh-candidatos">Candidatos</a></li>
                                    </ul>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a class="has-arrow waves-effect waves-dark" aria-expanded="false"><i class="mdi mdi-calendar-check"></i><span class="hide-menu">Eventos</span></a>
                                    <ul aria-expanded="false" class="collapse">
                                        <li><a href="<?php echo URL ?>wdadmin/eventos">Cadastro</a></li>
                                        <li><a href="<?php echo URL ?>wdadmin/relatorio-compras">Relatório de compras</a></li>
                                    </ul>
                                </li>
                                <li>
